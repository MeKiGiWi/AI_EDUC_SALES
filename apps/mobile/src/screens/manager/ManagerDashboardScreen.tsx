  ...
  return (
    <>
      <SectionHeader
        ...
        title="Команда, риски и coaching actions"
      ...
      <AppBottomSheet
        ...
        description={
          sheetState?.kind === "profile"
            ? "Профиль ученика и ближайший coaching focus."
            : sheetState?.kind === "dialogue"
              ? sheetState.transcript.scenarioTitle
              : sheetState?.kind === "training"
                ? "Mock form назначения тренировки без backend."
                : sheetState?.kind === "best-answer"
                  ? sheetState.example.scenarioTitle
                  : "Mock export подготовлен для mobile MVP."
        }
