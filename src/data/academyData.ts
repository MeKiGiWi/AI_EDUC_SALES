...
export const roleWorkspaceOptions: RoleWorkspaceOption[] = [
  {
    ...
    summary: "Практика, база знаний, личный прогресс, оценка, точки роста и персональный план.",
    capabilities: [
      "Личный прогресс и ближайшая практика",
      "База знаний и симулятор",
  ...
  },
  {
    ...
    summary: "Пользователи, роли, история обучения, знания, сценарии и правила отправки отчетов.",
    capabilities: [
      "Профили пользователей и уровни доступа",
      "История обучения и настройки доступа",
      "База знаний, импорты и сценарии",
    ...
    materials: [
      {
        ...
        applyInDialogue: "После симуляции сравни самый низкий блок оценки с реальной репликой, где разговор потерял темп или ясность.",
    ...
    materials: [
      {
        ...
        applyInDialogue: "Используй материал перед симуляцией, чтобы выбрать один конкретный навык и не распыляться на весь разговор сразу.",
    ...
    materials: [
      {
        ...
        applyInDialogue: "После симуляции сравни слабую реплику с сильным примером и выбери одну новую формулировку для следующей практики.",
...
export const learningModules: LearningModule[] = [
  ...
  },
  {
    ...
    durationMinutes: 15,
    completedPercent: 20,
    nextStep: "Открыть мини-симуляцию",
...
export const developmentTrack: DevelopmentTrack = {
  ...
  milestones: [
    "Пройти 2 микроурока",
    "Завершить 3 симуляции с score выше 80",
...
export const studentActionItems: ActionItem[] = [
  {
    ...
    description: "Запусти короткую симуляцию и попробуй удержать разговор в плоскости ROI.",
...
export const learningHistory: string[] = [
  ...
  "2 дня назад: score 82 в симуляции по диагностике",
...
export const managerActionItems: ActionItem[] = [
  ...
  {
    id: "m-act-2",
    title: "Проверить 3 проблемные симуляции",
    ...
    previewSections: [
      {
        ...
        lines: ["Средний score: 79/100", "В риске: 2 участника", "Активных симуляций: 5"]
      },
      {
        id: "rep-2-sec-2",
        title: "Фокус",
    ...
    previewSections: [
      {
        id: "rep-4-sec-1",
        title: "Результаты",
        lines: ["Прогресс: 73%", "Средний score: 79", "Активных симуляций: 5"]
      }
    ]
  },
  {
...
export const adminRoleRules: AccessRoleRule[] = [
  {
    ...
    role: "student",
    accessLevel: "self",
    permissions: ["Просмотр своего прогресса", "Симулятор", "База знаний"],
    exportTargets: ["pdf"]
  },
  {
    id: "role-rule-2",
...
export const studentDashboardData: StudentDashboard = {
  ...
  aiRecommendations: [
    "Перед каждой симуляцией выбери один навык, который хочешь проверить в разговоре.",
...
export const managerDashboardData: ManagerDashboard = {
  ...
  growthPoints: [
    ...
    "В части симуляций теряется конкретный следующий шаг в финале разговора."
  ],
