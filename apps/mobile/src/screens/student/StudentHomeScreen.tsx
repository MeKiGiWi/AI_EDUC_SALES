      ...
      <DevelopmentPlanCard
        ...
        onOpen={() =>
          setSheetState({
            ...
            description: "Здесь собраны текущий трек, milestones и рекомендации, которые ты уже добавил из AI feedback.",
            items: [
        ...
        onDownloadPlan={() =>
          setSheetState({
            kind: "export",
            title: "Mock export плана",
            description: "Пока без backend-интеграции: показываем, какие блоки попадут в PDF или XLSX выгрузку плана развития.",
            items: [
